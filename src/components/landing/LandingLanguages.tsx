...
const LABELS_FR: Labels = {
  ...
  body:
    "Du monde, alignées sur le CECRL — pour parler au monde. Africaines, alignées sur l’échelle YEMA (Écoute · Voix · Récit · Palabre · Foyer) — pour revenir à sa parole d’origine.",
  familyForeignEye: "Du monde",
  familyForeignTitle: "Pour ouvrir le monde",
  familyForeignSubtitle: "Échelle CECRL A1 → C1",
  familyNativeEye: "Africaines",
