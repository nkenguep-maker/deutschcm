...
const COPY_FR: Copy = {
  ...
  sourcesTitleEm: "racontent d'où l'on vient.",
  sourcesLede: "L'échelle YEMA, voix d'abord : É1 la salutation du matin, É2 le marché, É3 le conte du soir, É4 la palabre, É5 le foyer. Touchez un mot — la page s'écoute.",
...
const COPY_EN: Copy = {
  ...
  sourcesTitleEm: "tell where we come from.",
  sourcesLede: "The YEMA scale, voice first: É1 the morning greeting, É2 the marketplace, É3 the evening tale, É4 the palaver, É5 the home. Touch a word — the page listens.",
  sourcesScaleCap: "YEMA · É1 → É5",
