      ...
      <div style={{ marginBottom: 14, padding: "18px 20px", borderRadius: 16, background: isLocked ? "rgba(255,255,255,0.02)" : `${cfg.glow}`, border: `1px solid ${isLocked ? "rgba(255,255,255,0.06)" : cfg.border}` }}>
        <div style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ margin: "0 0 8px", color: "rgba(255,255,255,0.45)", fontSize: "0.72rem", lineHeight: 1.5 }}>
              {meta.subtitle}
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
              ...
              {!isLocked && (
                <span style={{ color: "rgba(255,255,255,0.28)", fontSize: "0.62rem" }}>
...
function JourneyBlock({ t }: { t: typeof T["fr"] }) {
  ...
  return (
    <div className="fade-up card-delay-1" style={{
      ...
      <p style={{ margin: "0 0 14px", color: "rgba(255,255,255,0.45)", fontSize: "0.75rem", lineHeight: 1.6 }}>
        {t.journeyText}
      </p>
