...
const STORIES: readonly Story[] = [
  ...
  },
  {
    ...
    quote: "Le passeport, on ne l'obtient pas avec l'accent. Alors j'apprends chaque soir.",
    quoteEn: "You don't get the passport with an accent. So I learn every evening.",
