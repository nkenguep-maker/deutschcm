...
const COPY_FR: Copy = {
  ...
  activLede: "YEMA n'est pas une place de marché anonyme. La maison examine chaque candidature avant d'ouvrir un espace enseignant.",
  activPrinciples: [
    "Les offres publiques YEMA restent les mêmes quel que soit l'enseignant.",
    "Pendant la bêta, aucun paiement n'est encaissé depuis l'espace enseignant.",
    "La candidature est examinée avant l'ouverture d'un espace enseignant.",
  ],
  ...
  formTitleEm: "La maison étudie votre candidature.",
  formLede: "Chaque candidature est examinée par l'équipe YEMA avant l'ouverture d'un espace enseignant. Nous vous recontactons après examen.",
  fldName: "Nom complet",
  fldEmail: "Email",
  ...
  sentTitleEm: "Votre candidature est enregistrée.",
  sentBody: "L'équipe YEMA pourra vous recontacter après examen de votre demande.",
...
const COPY_EN: Copy = {
  ...
  activLede: "YEMA isn't an anonymous marketplace. The house reviews every application before opening a teacher workspace.",
  activPrinciples: [
    "YEMA public offers stay the same regardless of the teacher.",
    "During beta, no payment is collected from the teacher workspace.",
    "Applications are reviewed before a teacher workspace is opened.",
  ],
  ...
  formTitleEm: "The house reviews your application.",
  formLede: "Every application is reviewed by the YEMA team before a teacher workspace is opened. We will contact you after review.",
  fldName: "Full name",
  fldEmail: "Email",
  ...
  sentTitleEm: "Your application has been recorded.",
  sentBody: "The YEMA team can contact you after reviewing your application.",
