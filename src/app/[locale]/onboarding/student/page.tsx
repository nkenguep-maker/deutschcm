...
const GOALS = [
  { value: "Tourisme",   icon: "",  label: "Tourisme",   desc: "Voyager en Allemagne ou en Autriche" },
...
const SCHEDULES = [
  ...
  { value: "apres-midi",   label: "Après-midi",   desc: "12h–18h" },
...
export default function StudentOnboardingPage() {
  ...
  const card = (style?: React.CSSProperties): React.CSSProperties => ({
    background: "rgba(36, 24, 18, 0.85)", border: "1px solid rgba(244, 235, 220, 0.09)",
    borderRadius: 18, padding: 28, backdropFilter: "blur(12px)", ...style,
  });

  const err = (k: keyof Form) => errors[k] ? (
    <div style={{ color: "#E5B4B7", fontSize: 11, marginTop: 4 }}>{errors[k]}</div>
  ) : null;

  return (
    <main style={{
      minHeight: "100vh", background: "var(--espresso)", display: "flex", alignItems: "center",
      ...
      <div style={{ width: "100%", maxWidth: 560 }} className="fadeUp">
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ margin: 0, color: "var(--creme)", fontFamily: "var(--font-fraunces), Georgia, sans-serif", fontWeight: 800, fontSize: 22 }}>
            Bienvenue sur Yema
          </h1>
          <p style={{ margin: "6px 0 0", color: "rgba(244, 235, 220, 0.62)", fontSize: 13 }}>
        ...
        <div style={card()}>
          ...
          {step === 0 && (
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              <h2 style={{ margin: 0, color: "var(--creme)", fontFamily: "var(--font-fraunces), Georgia, sans-serif", fontSize: 18 }}>Votre profil</h2>

              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <div>
                  <label style={{ color: "rgba(244, 235, 220, 0.72)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 6 }}>PRÉNOM <span style={{ color: "var(--creme-mute)", fontWeight: 400 }}>(recommandé)</span></label>
                  <input value={form.firstName} onChange={e => set("firstName")(e.target.value)} placeholder="Marie" style={inp()} />
                </div>
                <div>
                  <label style={{ color: "rgba(244, 235, 220, 0.72)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 6 }}>NOM <span style={{ color: "var(--creme-mute)", fontWeight: 400 }}>(recommandé)</span></label>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                <div>
                  <label style={{ color: "rgba(244, 235, 220, 0.72)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 6 }}>DATE DE NAISSANCE</label>
                ...
                <div>
                  <label style={{ color: "rgba(244, 235, 220, 0.72)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 6 }}>GENRE</label>
              ...
              <div>
                <label style={{ color: "rgba(244, 235, 220, 0.72)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 6 }}>VILLE</label>
              ...
              <div>
                <label style={{ color: "rgba(244, 235, 220, 0.72)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 6 }}>PHOTO DE PROFIL <span style={{ fontWeight: 400, color: "var(--creme-mute)" }}>(optionnel)</span></label>
          ...
          {step === 1 && (
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              <div>
                <h2 style={{ margin: 0, color: "var(--creme)", fontFamily: "var(--font-fraunces), Georgia, sans-serif", fontSize: 18 }}>Votre objectif</h2>
                <p style={{ margin: "6px 0 0", color: "rgba(244, 235, 220, 0.62)", fontSize: 13 }}>Pourquoi apprenez-vous l'allemand ? Cela nous aidera à personnaliser votre parcours.</p>
              </div>
              {err("learningGoal")}
                ...
                {GOALS.map(g => {
                  ...
                  return (
                    <button key={g.value} onClick={() => set("learningGoal")(g.value)} style={{
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ color: active ? "var(--brass)" : "var(--creme)", fontWeight: 700, fontSize: 14 }}>{g.label}</div>
                        <div style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 12, marginTop: 2 }}>{g.desc}</div>
                      </div>
                      {active && <span style={{ color: "var(--brass)", fontSize: 18 }}>✓</span>}
                    </button>
                  );
                })}
              </div>
          ...
          {step === 2 && (
            <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
              <div>
                <h2 style={{ margin: 0, color: "var(--creme)", fontFamily: "var(--font-fraunces), Georgia, sans-serif", fontSize: 18 }}>Votre disponibilité</h2>
                <p style={{ margin: "6px 0 0", color: "rgba(244, 235, 220, 0.62)", fontSize: 13 }}>Planifiez votre temps d'apprentissage quotidien.</p>
              </div>

              <div>
                <div style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 10 }}>Temps par jour</div>
                {err("availability")}
              ...
              <div>
                <div style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 10 }}>Horaire préféré</div>
              ...
              <div>
                <div style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 10 }}>
                  Comment souhaitez-vous apprendre ?
                </div>
                {errors.learningType && <div style={{ color: "#E5B4B7", fontSize: 11, marginBottom: 8 }}>{errors.learningType}</div>}
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {[
                    { value: "center",        icon: "", label: "J'ai un code de centre",  desc: "Rejoindre un centre de langue partenaire" },
                    ...
                    return (
                      <button key={opt.value} onClick={() => { set("learningType")(opt.value); setErrors(e => ({ ...e, learningType: "" })); }} style={{
                        ...
                        <div style={{ flex: 1 }}>
                          <div style={{ color: active ? "var(--brass)" : "var(--creme)", fontWeight: 700, fontSize: 14 }}>{opt.label}</div>
                          <div style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 12, marginTop: 2 }}>{opt.desc}</div>
                        </div>
                        {active && <span style={{ color: "var(--brass)", fontSize: 18 }}>✓</span>}
                      </button>
                    );
                ...
                {form.learningType === "center" && (
                  <div style={{ marginTop: 14, padding: "16px", background: "rgba(234,179,8,0.05)", border: "1px solid rgba(234,179,8,0.2)", borderRadius: 12 }}>
                    <label style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 8, textTransform: "uppercase" }}>
                      Code de centre
                    </label>
                    ...
                    {centerPreview && (
                      <div style={{ marginTop: 10, background: "rgba(234,179,8,0.06)", border: "1px solid rgba(234,179,8,0.2)", borderRadius: 8, padding: "10px 14px" }}>
                        <div style={{ color: "var(--creme)", fontWeight: 700, fontSize: 13 }}>{centerPreview.name}</div>
                ...
                {form.learningType === "classroom" && (
                  <div style={{ marginTop: 14, padding: "16px", background: "rgba(99,102,241,0.06)", border: "1px solid rgba(99,102,241,0.2)", borderRadius: 12 }}>
                    <label style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 8, textTransform: "uppercase" }}>Code de classe</label>
                    <div style={{ position: "relative" }}>
                      <input
                    ...
                    {errors.classCode && <div style={{ color: "#E5B4B7", fontSize: 11, marginTop: 4 }}>{errors.classCode}</div>}
                    {codePreview && (
                      <div style={{ marginTop: 10, background: "rgba(184, 135, 62, 0.06)", border: "1px solid rgba(184, 135, 62, 0.2)", borderRadius: 8, padding: "10px 14px" }}>
                        <div style={{ color: "var(--creme)", fontWeight: 700, fontSize: 13 }}>{codePreview.name}</div>
                        <div style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 11, marginTop: 4 }}>
                ...
                {form.learningType === "solo" && (
                  <div style={{ marginTop: 14, padding: "14px 16px", background: "rgba(184, 135, 62, 0.04)", border: "1px solid rgba(184, 135, 62, 0.15)", borderRadius: 12 }}>
                ...
                {form.learningType === "group_creator" && (
                  <div style={{ marginTop: 14, padding: "16px", background: "rgba(99,102,241,0.06)", border: "1px solid rgba(99,102,241,0.2)", borderRadius: 12 }}>
                    <div>
                      <label style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 6, textTransform: "uppercase" }}>Nom du groupe *</label>
                      ...
                      {errors.groupName && <div style={{ color: "#E5B4B7", fontSize: 11, marginTop: 4 }}>{errors.groupName}</div>}
                    </div>
                    <div style={{ marginTop: 12 }}>
                      <label style={{ color: "rgba(244, 235, 220, 0.62)", fontSize: 11, fontWeight: 600, display: "block", marginBottom: 8, textTransform: "uppercase" }}>Niveau cible</label>
                      <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                        {["A1","A2","B1","B2","C1"].map(l => (
                          <button key={l} onClick={() => set("groupLevel")(form.groupLevel === l ? "" : l)} style={{
                            ...
                            background: form.groupLevel === l ? "rgba(184, 135, 62, 0.15)" : "rgba(244, 235, 220, 0.04)",
                            border: `1px solid ${form.groupLevel === l ? "rgba(184, 135, 62, 0.4)" : "rgba(244, 235, 220, 0.09)"}`,
                            color: form.groupLevel === l ? "var(--brass)" : "rgba(244, 235, 220, 0.72)",
                          }}>{l}</button>
                        ))}
                      </div>
                    </div>
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "space-between", marginTop: 28 }}>
            {step > 0 ? (
              <button onClick={() => setStep(s => s - 1)} style={{
                background: "rgba(244, 235, 220, 0.04)", color: "rgba(244, 235, 220, 0.62)",
                border: "1px solid rgba(244, 235, 220, 0.09)", borderRadius: 10, padding: "12px 20px",
        ...
        <div style={{ textAlign: "center", marginTop: 16, color: "var(--creme-mute)", fontSize: 11 }}>
          Étape {step + 1} sur {STEPS.length} — vos données sont chiffrées.
        </div>
      </div>
    </main>
  );
