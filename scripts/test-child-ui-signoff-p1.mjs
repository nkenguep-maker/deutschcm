#!/usr/bin/env node
// Gate 8K · wrapper npm run test:child-ui-signoff:p1.
...
function die(code, msg) {
  console.error(`[test:child-ui-signoff:p1] ${msg}`);
  process.exit(code);
}
...
const child = spawn("npx", ["tsx", "scripts/orchestrate-child-ui-signoff-p1.ts"], {
  stdio: "inherit",
  env: {
    ...process.env,
