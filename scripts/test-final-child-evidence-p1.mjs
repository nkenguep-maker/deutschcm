#!/usr/bin/env node
// Gate 8J · wrapper npm run test:final-child-evidence:p1.
// NON-SKIPPABLE · flags Coach obligatoires.
...
function die(code, msg) {
  console.error(`[test:final-child-evidence:p1] ${msg}`);
  process.exit(code);
}
...
const child = spawn("npx", ["tsx", "scripts/orchestrate-final-child-evidence-p1.ts"], {
  stdio: "inherit",
  env: {
    ...process.env,
