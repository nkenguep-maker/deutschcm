#!/usr/bin/env node
// Gate 8H · wrapper npm run test:final-visual-evidence:p1.
...
function die(code, msg) {
  console.error(`[test:final-visual-evidence:p1] ${msg}`);
  process.exit(code);
}
...
const child = spawn("npx", ["tsx", "scripts/orchestrate-final-visual-evidence-p1.ts"], {
  stdio: "inherit",
  env: {
    ...process.env,
