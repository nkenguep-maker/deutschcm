#!/usr/bin/env node
// Gate 8K · wrapper capture · delegue au test orchestrator.
import { spawn } from "node:child_process";

const P1_REF = "kzzagbojjkivdzzcrmxn";
const BLOCKED = new Set(["sbjhvlrkbyjckdxujjsk", "mamofhrurksyuuolucea", "qggwvonfumuimjfsgpdz"]);

function die(code, msg) { console.error(`[capture:child-ui-signoff:p1] ${msg}`); process.exit(code); }
...
const child = spawn("node", ["scripts/test-child-ui-signoff-p1.mjs"], {
