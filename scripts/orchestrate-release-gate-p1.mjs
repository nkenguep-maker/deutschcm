...
const steps = [
  ...
  { name: "RLS inventory and domain gates", cmd: "node", args: ["scripts/test-baseline/p0-rls-gates.mjs"] },
  ...
  { name: "German A1 refonte v2 invariants", cmd: "node", args: ["scripts/test-baseline/p1-a1-adult-runtime-gate.mjs"] },
