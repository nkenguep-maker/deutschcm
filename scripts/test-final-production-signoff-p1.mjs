#!/usr/bin/env node
// Gate 8E · wrapper npm run test:final-production-signoff:p1.
...
function die(code, msg) {
  console.error(`[test:final-production-signoff:p1] ${msg}`);
  process.exit(code);
}
...
const child = spawn("node", [
  ...
  "--flag", "on", "--",
  "npx", "tsx", "scripts/orchestrate-final-production-signoff-p1.ts",
