#!/usr/bin/env node
// Gate 8C · wrapper npm run test:deployment-readiness:p1.
...
function die(code, msg) {
  console.error(`[test:deployment-readiness:p1] ${msg}`);
  process.exit(code);
}
...
const child = spawn("node", [
  ...
  "--flag", "on", "--",
  "npx", "tsx", "scripts/orchestrate-deployment-readiness-p1.ts",
