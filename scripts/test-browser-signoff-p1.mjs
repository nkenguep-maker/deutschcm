#!/usr/bin/env node
// Gate 8F · wrapper npm run test:browser-signoff:p1.
// NON-SKIPPABLE · fail-closed · Playwright réel obligatoire.
...
function die(code, msg) {
  console.error(`[test:browser-signoff:p1] ${msg}`);
  process.exit(code);
}
...
const child = spawn("node", [
  ...
  "--flag", "on", "--",
  "npx", "tsx", "scripts/orchestrate-browser-signoff-p1.ts",
