#!/usr/bin/env node
// Gate 8I · wrapper npm run test:final-browser-acceptance:p1.
// NON-SKIPPABLE · flags Coach obligatoires · bypass allowlist.
...
function die(code, msg) {
  console.error(`[test:final-browser-acceptance:p1] ${msg}`);
  process.exit(code);
}
...
const child = spawn("npx", ["tsx", "scripts/orchestrate-final-browser-acceptance-p1.ts"], {
  stdio: "inherit",
  env: {
    ...process.env,
