...
> - **418 tests pass · TypeScript clean · build vert · 26/26 assertions smoke E2E** (Playwright + Prisma live) couvrant workflow adulte complet, ajout/retrait enfant, coach lifecycle admin, concurrence double-accept, cap 5ᵉ enfant, cap coach.
